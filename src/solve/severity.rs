...
mod tests {
    ...
    fn test_enforced_enforced() {
        assert_eq!(compute_severity(Authority::Enforced, Authority::Enforced), Severity::Error);
    }

    #[test]
    fn test_enforced_declared() {
        assert_eq!(compute_severity(Authority::Enforced, Authority::Declared), Severity::Error);
    }

    #[test]
    fn test_enforced_advisory() {
        assert_eq!(compute_severity(Authority::Enforced, Authority::Advisory), Severity::Warning);
    }

    #[test]
    fn test_declared_declared() {
        assert_eq!(compute_severity(Authority::Declared, Authority::Declared), Severity::Warning);
    }

    #[test]
    fn test_declared_advisory() {
        assert_eq!(compute_severity(Authority::Declared, Authority::Advisory), Severity::Info);
    }

    #[test]
    fn test_advisory_advisory() {
        assert_eq!(compute_severity(Authority::Advisory, Authority::Advisory), Severity::Info);
    }
}
